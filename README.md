# Visual Tracking Paper List and Benchmark
...
- **FCOT:** Yutao Cui, Cheng Jiang, Limin Wang, Gangshan Wu.<br />
  ...
  [[github](https://github.com/MCG-NJU/FCOT)]
...
* **Siam R-CNN:** Paul Voigtlaender, Jonathon Luiten, Philip H.S. Torr, Bastian Leibe.<br />
  ...
  [[github](https://www.vision.rwth-aachen.de/page/siamrcnn)]
...
* **GradNet:** Peixia Li, Boyu Chen, Wanli Ouyang, Dong Wang, Xiaoyun Yang, Huchuan Lu. <br />
  ...
  [[github](https://github.com/LPXTT/GradNet-Tensorflow)]
...
* **SPLT:** Bin Yan, Haojie Zhao, Dong Wang, Huchuan Lu, Xiaoyun Yang <br />
  ...
  [[github](https://github.com/iiau-tracker/SPLT)]
...
* **ARCF:** Ziyuan Huang, Changhong Fu, Yiming Li, Fuling Lin, Peng Lu. <br />
  ...
  [[github](https://github.com/vision4robotics/ARCF-tracker)]
...
* **UpdateNet:** Lichao Zhang, Abel Gonzalez-Garcia, Joost van de Weijer, Martin Danelljan, Fahad Shahbaz Khan. <br />
  ...
  [[github](https://github.com/zhanglichao/updatenet)]
...
* **GFS-DCF:** Tianyang Xu, Zhen-Hua Feng, Xiao-Jun Wu, Josef Kittler. <br />
  ...
  [[github](https://github.com/XU-TIANYANG/GFS-DCF)]
...
- **EDCF:** Qiang Wang, Mengdan Zhang, Junliang Xing, Jin Gao, Weiming Hu, and Stephen Maybank.<br />
  "Do not Lose the Details: Reinforced Representation Learning for High Performance Visual Tracking." IJCAI (2018). 
  [[paper](https://www.ijcai.org/Proceedings/2018/0137.pdf)] 
...
**[[VOT18_paper_ECCV](https://sci-hub.tw/10.1007/978-3-030-11009-3_1)]The Visual Object Tracking VOT2018 challenge results**
